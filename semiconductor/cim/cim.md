...
- **EAP开发**: EAP 代码开发方式: 1、流程图编辑, 公共库拖拽; 2、By Type 自行编写私有资源库.
...
- **与泛微门户集成**: 需包含门户管理等模块集成.
- **与帆软报表集成**: 需包含报表管理等模块集成 (预留, 优先经 MES 汇聚).
...
- **MES 联动处置**: 通过集成 MES 支持 Hold Lot/Hold Tool/Hold Chamber/Hold Recipe, 并支持 Stop Tool/Stop Chamber 及客制化 OCAP;集成范围涵盖 MES/EAP/AMS;支持增加其他 Parameter 作为 OCAP 触发的附加判断条件.
...
支持数据保留, 备份, 开发运维工具与配置管理.

- **系统运维**: 支持 Trace Data 至少保存 6 个月，Summary Data 至少保存 1 年.
- **系统运维**: 支持设置产线数据保留期限及完善的备份机制.
- **系统运维**: 便捷高效的开发工具.
- **系统运维**: 提供系统的详细操作说明书，便于开发运维人员快速学习和解决疑难问题.
- **系统运维**: 支持一站式可视化便捷管理程序的运行配置，支持批量复制粘贴.
...
- **与泛微门户集成**: 需包含门户管理、协同管理等模块集成.
- **与用友 ERP 集成**: 需包含财务管理 (工单 / 物料 / 成本) 等模块集成.
- **与 WMS 集成**: 需包含物料出入库、库存管理等模块集成.
- **与 PLM 集成**: 需包含产品数据、工艺数据、BOM 管理等模块集成.
- **与帆软报表集成**: 需包含报表管理等模块集成.
- **与文档档案系统集成**: 需包含文档管理、档案管理等模块集成.
- **与电子签章平台集成**: 需包含电子签章 (CA) 等模块集成.

### 58. AGVC 对接

MES 与 AGVC (AGV 搬送控制) 系统的对接需求.
